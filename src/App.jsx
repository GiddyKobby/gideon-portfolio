    ...
    <>
      ...
      <section className="about" id="about" data-aos="fade-up">
        ...
        <div className="about-container">
          ...
          />
          <p>
            I'm a passionate software developer with a strong foundation in frontend development and a growing expertise in backend systems, driven by a mission to harness technology for a better world.
            <br /><br />
            I thrive on building clean, responsive, and user-centered digital experiences that make a meaningful impact. What makes me unique is my commitment to using code for real-world problem-solving, especially in areas like youth opportunity, education, and digital access.
            <br /><br />
            Whether designing intuitive interfaces or developing scalable backend logic, I aim to create software that adds real value. I'm always learning, always building, and always embracing new challenges.
            <br /><br />
            For me, the sky is just the starting point, and developer is more than a job title. It's how I bring ideas to life, create opportunities for others, and work toward a future where technology serves everyone.
          </p>
        </div>
      ...
      <section className="skills" id="skills" data-aos="fade-up">
        ...
        <p className="skills-intro">
          Here are the technologies I use regularly to build and deploy web applications:
        </p>
      ...
      <section className="portfolio" id="portfolio" data-aos="fade-up">
        <div className="project-card" data-aos="zoom-in" data-aos-delay="150">
          <img src="https://unsplash.it/800/600?random&gravity=center" alt="Dashboard App" />
          <h3>Phase 2 Project</h3>
          <p>Links to Phase 2 Project video on YouTube and Slide Deck.</p>
          <div className="buttons">
            <a
              href="https://youtu.be/Nu_YQZf_s0c"
              target="_blank"
            ...
            <a
              href="https://docs.google.com/presentation/d/1boxXIrNYcFOWzrX6eDJEeDXeyxDBm2wT/edit?usp=sharing"
              target="_blank"
              rel="noopener noreferrer"
            >
              Project Slide Deck
      ...
      <section className="video-section" id="elevator-pitch" data-aos="fade-up">
        ...
        <video width="100%" height="auto" controls title="Elevator Pitch Video">
      ...
      <section className="contact" id="contact" data-aos="fade-up">
        ...
        {submitted && <p>Thanks! I'll get back to you shortly.</p>}
      </section>
